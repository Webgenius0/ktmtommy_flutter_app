...
import 'package:ktmtommy_apps/features/athlet_flow/athlet_log/data/delate_log_supliment/api.dart';
...
final class DeleteLogSupplementRx extends RxResponseInt<Map<dynamic, dynamic>> {
  final api = DeleteLogSupplementApi.instance;

  DeleteLogSupplementRx({required super.empty, required super.dataFetcher});
  ...
  Future<bool> deleteSleepApiInfo({
    ...
    try {
      ...
      Map<dynamic, dynamic> data = await api.deleteLogSupplementApi(id: id);
