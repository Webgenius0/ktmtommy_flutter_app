...
class _DailySummerySettingsScreenState
  ...
  Future<void> _saveSettings() async {
    if (nameController.text.trim().isEmpty) {
      ToastUtil.showShortToast("Please enter dietitian name");
      return;
    }
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  UIHelper.verticalSpace(20),
                                  Text('dietitian Name', style: TextFontStyle.textStyle14w400cA3A3A3poppins),
                              ...
                              child: Row(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Icon(Icons.lock_outline, color: AppColors.primaryColor, size: 18.sp),
                                  ),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          "Privacy Notice",
                                          style: TextFontStyle.headline18w500cFFFFFF.copyWith(color: const Color(0xFF87B842), fontSize: 16),
                                        ),
                                        Text(
  ...
  Widget _bullet(String text) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('•  ', style: TextFontStyle.textStyle14w400c87B842poppins.copyWith(color: Colors.white, fontSize: 20)),
          Expanded(
            child: Text(text, style: TextFontStyle.textStyle14w400c87B842poppins.copyWith(color: Colors.white)),
          ),
        ],
      ),
    );
