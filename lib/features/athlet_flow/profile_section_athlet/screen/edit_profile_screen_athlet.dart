...
class EditProfileScreenAthlet extends StatefulWidget {
  ...
  @override
  State<EditProfileScreenAthlet> createState() => _EditProfileScreenAthletState();
}
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: Padding(
          ...
          child: SvgPicture.asset(icon, width: 20.w, height: 20.h, colorFilter: const ColorFilter.mode(AppColors.cF55216, BlendMode.srcIn)),
        ),
