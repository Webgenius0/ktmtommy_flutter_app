...
import 'package:ktmtommy_apps/features/recovery_mood_section/profile_section/widget/confirmation_dialog_box.dart';
...
class _MyProfileSettingScreenAthletState extends State<MyProfileSettingScreenAthlet> {
  @override
                                  ...
                                  children: [
                                    SvgPicture.asset(
                                      ...
                                      colorFilter: isPremium
                                          ? const ColorFilter.mode(AppColors.cF55216, BlendMode.srcIn)
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          NavigationService.navigateTo(Routes.changePasswordScreenAthlet);
                          log("================>>> Update Password Clicked changePasswordScreenAthlet");
                        },
                        child: _buildMenuRow(
                      ...
                      GestureDetector(
                        onTap: () {
                          showDialog(
                            context: context,
                            builder: (context) => ConfirmationDialogBoxAthlet(
                              title: "Log Out ?",
                              message:
                              ...
                              onConfirm: () async {
                                ...
                                try{
                                  bool isLogout = await postLogOutRXObj.logout();
                              ...
                              confirmButtonColor: AppColors.cF55216,
                            ),
                          );
                        },
                        child: _buildMenuRow(
