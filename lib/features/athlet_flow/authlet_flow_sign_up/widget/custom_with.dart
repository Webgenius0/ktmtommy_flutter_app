                ...
                children: [
                  Expanded(
                    child: CustomTextfield(
                      ...
                      controller: controller,
                      textAlign: TextAlign.start,
                      hintText: 'Enter weight (e.g., 70.5)',
                      hintTextSyle: TextFontStyle.textStyle16w400c757575poppins,
                      ...
                      validator: validator ?? (value) {
                        ...
                        // Allow integers and decimals (e.g., 70 or 70.5)
                        if (!RegExp(r'^\d+(\.\d{1,2})?$').hasMatch(value)) {
                          return "Enter a valid weight (e.g., 70 or 70.5)";
                        }
                        double? weight = double.tryParse(value);
                        if (weight == null || weight <= 0) {
                          return "Weight must be greater than 0";
                        }
                        // Reasonable weight range (e.g., 20-500 kg or lbs)
