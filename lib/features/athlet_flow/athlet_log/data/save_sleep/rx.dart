...
final class SaveSleepRx extends RxResponseInt<Map<dynamic, dynamic>> {
  final api = SaveSleepApi.instance;

  SaveSleepRx({required super.empty, required super.dataFetcher});

  ValueStream<Map<dynamic, dynamic>> get registrationData => dataFetcher.stream;

  ///=================== Call the Recovery Register API ===================///
  Future<bool> saveSleepApiInfo({
    ...
    try {
      ...
      Map<dynamic, dynamic> data = await api.saveSleepApi(date: date, bedTime: bedTime, wakeUpTime: wakeUpTime);
