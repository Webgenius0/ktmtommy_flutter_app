...
class CustomRiceBowl extends StatefulWidget {
  const CustomRiceBowl({
    super.key,
  ...
  @override
  State<CustomRiceBowl> createState() => _CustomRiceBowlState();
}

class _CustomRiceBowlState extends State<CustomRiceBowl> {
