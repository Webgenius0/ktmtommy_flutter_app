...
// import 'package:ktmtommy_apps/features/recovery_mood_section/recovery_journey/widget/custom_motivation.dart';
// import 'package:ktmtommy_apps/features/recovery_mood_section/recovery_journey/widget/custom_trainer.dart';
        ...
        builder: (context, setStateDialog) {
          return AlertDialog(
            ...
            title: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                SvgPicture.asset(AppIcons.disclamericon,
                    height: 24.h, color: AppColors.c87B842),
                UIHelper.horizontalSpace(16.w),
                Text(
                  'Disclaimer',
                  textAlign: TextAlign.center,
                            ...
                            return Padding(
                              ...
                              child: CustomTrainer(
                                ...
                                onTap: () {
                                  ...
                                  print("Selected Trainer: ${trainer['text']}");
                        ...
                        CustomButtonWidget(
                          ...
                          onTap: () {
                            if (selectedIndex != -1) {
                              ...
                              print("Final Selected Trainer: ${allTrainers[selectedIndex]['text']}");
                            } else {
