                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                          ...
                          onTap: () async {
                            if (_medicationFormKey.currentState!.validate() &&
                              ...
                              try {
                                ...
                                log('>>>>>>===========<<<<<');
                                log('===========>>>Medication Name: $name');
                                log('===========>>>Dosage: $dosage $dosageUnit');
                                log('===========>>>Is Prescribed: $isPrescribed');
                                log('===========>>>Taken At: $takenAt');
                                log('===========>>>Upright Posture: $uprightPosture');
                                log('===========>>>Water Intake: $waterIntake');
                                log('===========>>>Glass of Water: $glassOfWater');
                                log('===========>>>Notes: $notes');
                                log('>>>>>>===========<<<<<');
                        ...
                        ///=========== Recent Medication List StreamBuilder=====
                        GestureDetector(
                          onTap: () {
                            NavigationService.navigateTo(
                                Routes.recentMedicationScreen);
                          ...
                          child: StreamBuilder(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final limitedMedication =
                                  medication.take(2).toList();
                                  ...
                                  return StatefulBuilder(
                                    builder: (context, setItemState) {
                                      return CustomAcetaminophen(
                                        ...
                                        deleteIcon: index < deleteIcon.length
                                            ? deleteIcon[index]
                                            : 'assets/icons/default_delete_icon.svg',
                                        onDelete: () async {
                                          ...
                                          final backupMedication =
                                              List.from(medication);

                                          setState(() {
                                            medication.removeWhere(
                                                (m) => m.id == item.id);
                                          });

                                          try {
                                            bool success =
                                                await deleteMedicationRxObj
                                                    .deleteMedicationApi(
                                                        id: item.id.toString());
                                            if (success) {
                                            ...
                                            setState(() {
                                              medication.clear();
                                              medication.addAll(backupMedication
                                                  .map((item) => item is Datum
                                                      ? item
                                                      : Datum.fromJson(item)));
                                            });
                                          } finally {
