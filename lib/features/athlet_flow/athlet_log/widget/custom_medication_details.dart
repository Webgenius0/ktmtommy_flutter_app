...
//   final TextEditingController amountUnitController;
...
//     this.onToggleChanged, required this.amountUnitController,
//
//   });
//
//   void dispose() {
...
//                           setState(() {
//                             isOn = value;
//                             widget.onToggleChanged?.call(isOn);
//                           });
//                         },
//                       ),
//                     ),
...
class CustomMedicationDetails extends StatefulWidget {
  ...
  const CustomMedicationDetails({
    ...
    required this.amountUnitController,
  });
...
class _CustomMedicationDetailsState extends State<CustomMedicationDetails> {
  ...
  void initState() {
    ...
    widget.amountUnitController.text = selectedUnit;
  }
                      ...
                      child: Container(
                        ...
                        child: PopupMenuButton<String>(
                          ...
                          onSelected: (String value) {
                            setState(() {
                              selectedUnit = value;
                              // Transfer the selected value to the controller
                              widget.amountUnitController.text = value;
                            });
                          },
                          itemBuilder: (BuildContext context) {
                            return durationList.map((String value) {
