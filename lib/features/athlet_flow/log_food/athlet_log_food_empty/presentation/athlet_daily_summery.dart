...
class AthletDailySummeryScreen extends StatefulWidget {
  const AthletDailySummeryScreen({super.key});

  @override
  State<AthletDailySummeryScreen> createState() => _AthletDailySummeryScreenState();
}

class _AthletDailySummeryScreenState extends State<AthletDailySummeryScreen> {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: ShapeDecoration(
                                  color: const Color(0x33FFB84D), // Orange with opacity
                                  shape: RoundedRectangleBorder(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    UIHelper.horizontalSpace(4),
                                    Text(
                                      "Breakfast", // Changed from "8:00 AM" to "Breakfast"
                  ...
                  /// Second Food Item (Lunch example)
                  Container(
                    width: double.infinity,
                    padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 13),
                    decoration: ShapeDecoration(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            InkWell(
                                onTap: (){
                                  NavigationService.navigateTo(Routes.athletDailySummerySettingsScreen);
                                },
                                child: Icon(
                                  Icons.settings,
                                  color: AppColors.orangeColor, // Changed to orange
